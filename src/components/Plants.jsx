...
const PLANTS_DATA = [
  ...
  { id: 'moneyplant', name: 'Golden Pothos (Money Plant)', category: 'Indoor', price: 45, originalPrice: 65, stock: 32000, origin: 'Jagatpura Flora Farm', image: 'https://images.unsplash.com/photo-1747156198758-e12dfd4fe7ee?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8R29sZGVuJTIwUG90aG9zJTIwKE1vbmV5JTIwUGxhbnQpfGVufDB8fDB8fHww', desc: 'Trailing air-purifying vine with beautiful golden-variegated green leaves.' }
];
